...
file_path = 'Technique_Dataset_LLM_Finetuning.csv'
df = pd.read_csv(file_path)

# Remove two columns by name or index
columns_to_remove = ['Hash Name', 'T1458','T1660','T1456','T1631','T1664','T1663','T1461','T1661','T1639','T1641','T1474','T1603','T1638']  # Replace with actual column names
...
class_names =["T1424", "T1604", "T1532", "T1404", "T1422", "T1577", "T1437", "T1512", "T1430", "T1418", 
 "T1624", "T1645", "T1429", "T1417", "T1481", "T1426", "T1644", "T1471", "T1420", "T1623", 
 "T1655", "T1544", "T1643", "T1617", "T1630", "T1646", "T1640", "T1398", "T1521", "T1582", 
 "T1421", "T1642", "T1409", "T1616", "T1636", "T1407", "T1633", "T1662", "T1533", "T1516", 
 "T1406", "T1575", "T1637", "T1414", "T1513", "T1509", "T1541", "T1517"]
...
def evaluate_and_save_results(predictions, tokenized_ds, x_test, seed, class_names):
    """
    Evaluate the model's predictions and save metrics and results to files.
    ...
    y_true = np.array([example['labels'] for example in tokenized_ds['test']])
    y_pred = predictions.predictions > 0.5  # Threshold predictions for multi-label classification
    ...
    with open(f"cysec_BERT_Technique_evaluation_metrics_seed_{seed}.txt", "w") as txt_file:
    ...
    results_df.to_csv(f'cysec_BERT_Technique_test_predictions_seed_{seed}.csv', index=False)
...
random_seeds = [1600,2396]  # Replace with your desired seeds
...
for seed in random_seeds:
  ...
  training_args = TrainingArguments(
      output_dir = f'cysec_bert_multilabel_seed_{seed}',
      learning_rate = 1e-5,
...
all_metrics_df.to_csv("cysec_BERT_Technique_all_seed_evaluation_metrics.csv", index=False)
