...
def evaluate_and_save_results(predictions, tokenized_ds, x_test, seed, class_names):
    ...
    results_df.to_csv(f'sec_BERT_Tactic_test_predictions_seed_{seed}.csv', index=False)
...
all_metrics_df.to_csv("sec_BERT_Tactic_all_seed_evaluation_metrics.csv", index=False)
